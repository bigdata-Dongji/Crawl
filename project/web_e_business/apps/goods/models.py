...
class Goods(models.Model):
    ...
    goods_sn=models.CharField(max_length=50,default=0,verbose_name='商品唯一货号')
...
class GoodsImage(models.Model):
    ...
    image_url=models.ImageField(max_length=300,null=True,blank=True,verbose_name='图片url')
    add_time=models.DateTimeField(default=datetime.now,verbose_name='添加时间')
