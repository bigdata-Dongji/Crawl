    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('personal', '个人'), ('college', '高校'), ('training', '培训机构')], default='college', max_length=10, verbose_name='机构类别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_days', models.IntegerField(default=0, verbose_name='工作年限')),
